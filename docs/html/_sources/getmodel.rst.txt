...
Clone the `SCHISM source code <https://github.com/schism-dev>`_. If you are working on Windows (which is mostly useful for instruction or reduced size problems), compatible 
