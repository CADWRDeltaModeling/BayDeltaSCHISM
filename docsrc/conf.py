...
latex_documents = [
    (
        "index",
        "Bay-DeltaSCHISM.tex",
        "Bay-Delta SCHISM Documentation",
        "Eli Ateljevich, Joseph Zhang, Kijin Nam, Qiang Shu, Rueen-fang Wang",
        "manual",
    ),
]
...
epub_title = "Bay-Delta SCHISM"
epub_author = "Eli Ateljevich, Joseph Zhang, Kijin Nam, Qiang Shu, Rueen-fang Wang"
epub_publisher = "Eli Ateljevich, Joseph Zhang, Kijin Nam, Qiang Shu, Rueen-fang Wang"
epub_copyright = (
    "2014, Eli Ateljevich, Joseph Zhang, Kijin Nam, Qiang Shu, Rueen-fang Wang"
)
...
intersphinx_mapping = {
    "schimpy": (
        ...
        "https://github.com/CADWRDeltaModeling/schimpy/raw/gh-pages/objects.inv",
    )
}
tls_verify = False
